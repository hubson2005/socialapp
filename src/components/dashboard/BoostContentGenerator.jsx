      ...
      {activeTab==='text' && (
        <div style={{ display:'flex',flexDirection:'column',gap:'10px' }}>
          ...
          <div style={{ display:'flex',flexDirection:'column',gap:'6px' }}>
            <label style={{ display:'flex',alignItems:'center',gap:'5px',color:'rgba(255,255,255,0.4)',fontSize:'10px',fontWeight:600 }}>
            ...
            <div style={{ padding:'14px' }}>
              {!cur
                ...
                : <div style={{ display:'flex',flexDirection:'column',gap:'10px' }}>
                    ...
                    <div>
                      <p style={{ color:'rgba(255,255,255,0.4)',fontSize:'9px',fontWeight:600,margin:'0 0 5px',display:'flex',alignItems:'center',gap:'6px' }}>
                        TEXTE DU POST
                        <span style={{ fontWeight:400, color: overLimit ? '#ef4444' : 'rgba(255,255,255,0.2)' }}>
                          {cur.text?.length||0} / {NETWORK_CONFIG[activeNetwork]?.maxChars} chars
                        </span>
                        <span style={{ fontWeight:400,color:'rgba(255,255,255,0.2)',marginLeft:'auto',display:'flex',alignItems:'center',gap:'3px' }}>
                      ...
                      <textarea
                        ...
                        style={{
                          ...
                          color:'rgba(255,255,255,0.85)', fontSize:'12px', lineHeight:'1.6',
