...
const MetaLogo = () => (
  <svg viewBox="0 0 36 36" width="24" height="24" xmlns="http://www.w3.org/2000/svg">
    <defs>
      <linearGradient id="meta1" x1="0%" y1="0%" x2="100%" y2="0%"><stop offset="0%" stopColor="#0064E1"/><stop offset="100%" stopColor="#0082FB"/></linearGradient>
      <linearGradient id="meta2" x1="0%" y1="0%" x2="100%" y2="60%"><stop offset="0%" stopColor="#0082FB"/><stop offset="100%" stopColor="#00B2FF"/></linearGradient>
    </defs>
...
const MailchimpLogo = () => (
  <svg viewBox="0 0 256 256" width="24" height="24" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M179.4 129.6c1.5-.4 2.8-.5 3.7-.2.5.2.7.4.8.6.3.8-.3 2.1-1 3.1-.7 1.1-1.6 2-1.6 2s1.7-.2 3-.9c.8-.4 1.4-1 1.4-1.8 0-1.1-1-2.1-2.8-2.6-.8-.2-1.7-.3-2.6-.3.3-.3.5-.6.8-.9-.3-.2-.6-.4-.9-.6-.3.2-.5.4-.8.6z" fill="#241C15"/>
  </svg>
);
const SlackLogo = () => (
...
const SupabaseLogo = () => (
  <svg viewBox="0 0 512 512" width="24" height="24" xmlns="http://www.w3.org/2000/svg">
    <defs>
      <linearGradient id="sb1" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stopColor="#3ECF8E"/><stop offset="100%" stopColor="#1C7A4A"/></linearGradient>
    </defs>
  ...
  return (
    <div style={{
      ...
      <div onClick={() => hasContent && setExpanded(v => !v)} style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '14px', minWidth: 0, cursor: hasContent ? 'pointer' : 'default' }}>
        ...
        {/* Boutons — frères du div cliquable, pas enfants */}
        {isConnected && (
          <button
