    ...
    const fetchProfile = async () => {
      ...
      if (error || !data) {
        ...
        await supabase.from('profile_stats').insert([
          { profile_id: data.id, event_type: 'view' },
        ]);
      }
      setLoading(false);
    };
  ...
  return (
    <>
      ...
      >
        ...
        {profile.bio && (
          <p style={{ color: 'rgba(255,255,255,0.8)', fontSize: '14px', textAlign: 'center', maxWidth: '300px', marginBottom: '16px' }}>
            {profile.bio}
          </p>
        )}
            ...
            {countdown && (
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: '8px', marginBottom: '12px' }}>
                {[
                  ...
                  >
                    <div style={{ fontSize: '24px', fontWeight: '800', color: '#ff6b35', lineHeight: 1 }}>
