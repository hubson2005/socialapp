...
export default function UserDashboard() {
  ...
  return (
    // ✅ FIX: suppression de transform sur le root pour ne pas casser position:fixed des enfants
    <div style={{
      height: '100dvh',
      minHeight: '100dvh',
      overflow: 'hidden',
      ...
      {/* Main — ✅ FIX: suppression de transform ici aussi */}
      <div style={{
        flex: 1,
        height: '100dvh',
        minHeight: '100dvh',
      ...
      {/* ✅ FIX: MobileNav EN DEHORS du div Main transformé → position:fixed fonctionne correctement */}
      {isMobile && (
        <MobileNav
          activeSection={activeSection}
          onNavigate={setActiveSection}
